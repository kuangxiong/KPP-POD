...
void
kpp_mpi_svd_c_(int *ncup1, int *N1, int *localN1, complex *data, float *S, complex *U, int *numprocs, int *rank)
{  
    int ncup, N, localN, nprocs, myid, k;
