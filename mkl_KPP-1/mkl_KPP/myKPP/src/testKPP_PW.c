 ...
 */
/* ============================================================================*/
void testKPP_PW(int N, DOUBLE lam, DOUBLE eps, DOUBLE tau, DOUBLE theta, DOUBLE dt, DOUBLE t, 
...
//	 while(niter < 250)
	 {
        ...
        cost = cos(t);
        t = t + dt;
        KPP_ComputePlane(N, t, dt, C, Amp, lam, theta, eps, cost, u_hat, myrank, nprocs,localN, 
                        local_0_start,  comm);
