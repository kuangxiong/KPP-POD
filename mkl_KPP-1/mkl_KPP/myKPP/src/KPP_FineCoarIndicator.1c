 ...
 *
 * @Param         N        number of the coarse grid dof
 * @Param         laml1    \lambda
 * @Param         eps      \eps
 ...
 */
/* ============================================================================*/
void KPP_FineCoarIndicator(int NN1, DOUBLE lam, DOUBLE eps, DOUBLE tau, DOUBLE theta, DOUBLE dt1, 
			  DOUBLE Amp, DOUBLE cM, DOUBLE C, int myrank, int nprocs, int *timeflag, MPI_Comm comm1)
{     
     ...
     fftw_plan p1, p2;
     int i, k, j, niter = 0, ONE=1, N1, N2, nPOD, nPOD1, nPOD2,  tmpN, tmpN1, flag, count;
