...
void
KPP_mpi_svd(int ncup, int N, int localN, complex *data, float *S, complex *U, int nprocs, int myid)
{  
...
//	}
	...
	mU = localN * N;
	/*******************************************************************/
    descA[0] = 1; descA[1] = context; descA[2] =M; descA[3]= ncup; descA[4]= 1; 
    descA[5]= 1; descA[6] = 0; descA[7] = 0; descA[8]= mA;
    descU[0] = 1; descU[1] = context; descU[2] =M; descU[3]= M; descU[4]= 1; 
